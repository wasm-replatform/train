...
// use wasi_messaging::types::{self as messaging, Message};
...
//     async fn handle(message: Message) -> Result<(), messaging::Error> {
...
//             return Err(messaging::Error::Other("Incorrect environment".to_string()));
//         };
...
//             }
//             _ => {
//                 return Err(messaging::Error::Other("Unhandled topic".to_string()));
//             }
//         } {
//             return Err(messaging::Error::Other(e.to_string()));
//         }
